    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock', models.CharField(choices=[('New', 'New'), ('IN STOCK', 'IN STOCK'), ('OUT OF STOCK', 'OUT OF STOCK')], max_length=200)),
                ('status', models.CharField(choices=[('Publish', 'Publish'), ('Draft', 'Draft')], max_length=200)),
                ('created_date', models.DateField(default=django.utils.timezone.now, max_length=200)),
